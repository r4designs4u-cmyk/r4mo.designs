...
const CREATORS = [
    { name: 'Alex Rivera', avatar: 'https://i.postimg.cc/8c1S4rwg/channels4-profile.jpg' },
    { name: 'Sarah Chen', avatar: 'https://i.postimg.cc/C5Fg7fJT/channels4-profile-(1).jpg' },
    { name: 'Mike Johnson', avatar: 'https://i.postimg.cc/3NKT1D1z/channels4-profile-(2).jpg' },
    { name: 'Emma Wilson', avatar: 'https://i.postimg.cc/pr2HCnC7/channels4-profile-(3).jpg' },
    { name: 'David Kim', avatar: 'https://i.postimg.cc/RhMBdndg/channels4-profile-(4).jpg' },
    { name: 'Lisa Park', avatar: 'https://i.postimg.cc/yxVHjSjG/channels4-profile-(5).jpg' },
    { name: 'James Brown', avatar: 'https://i.postimg.cc/wM6p2s20/channels4-profile-(6).jpg' },
];
...
const TESTIMONIALS = [
    {
        ...
        avatar: 'https://i.postimg.cc/8c1S4rwg/channels4-profile.jpg',
    },
    {
        name: 'Sarah Chen',
        ...
        avatar: 'https://i.postimg.cc/C5Fg7fJT/channels4-profile-(1).jpg',
    },
    {
        name: 'Mike Johnson',
        ...
        avatar: 'https://i.postimg.cc/3NKT1D1z/channels4-profile-(2).jpg',
    },
    {
        name: 'Emma Wilson',
        ...
        avatar: 'https://i.postimg.cc/pr2HCnC7/channels4-profile-(3).jpg',
    },
    {
        name: 'David Kim',
        role: 'Review Channel • 600K subs',
        content: 'Incredibly talented designer who actually understands YouTube. Worth every penny!',
        avatar: 'https://i.postimg.cc/RhMBdndg/channels4-profile-(4).jpg',
    },
    {
        name: 'Lisa Park',
        role: 'Vlog Channel • 350K subs',
        content: 'Working with R4MO was a game-changer. My videos finally get the attention they deserve!',
        avatar: 'https://i.postimg.cc/yxVHjSjG/channels4-profile-(5).jpg',
    },
];
// Scroll row images (derived from portfolio)
const snaxItem = PORTFOLIO_ITEMS.find(p => p.client === 'Snax');
const tigerItem = PORTFOLIO_ITEMS.find(p => p.client === 'Tiger');
const SCROLL_ROW_1 = snaxItem
    ? [snaxItem.image, ...PORTFOLIO_ITEMS.filter(p => p.client !== 'Snax').slice(0, 7).map(p => p.image)]
    : PORTFOLIO_ITEMS.slice(0, 8).map(p => p.image);
const SCROLL_ROW_2 = tigerItem
    ? [tigerItem.image, ...[...PORTFOLIO_ITEMS].reverse().filter(p => p.client !== 'Tiger').slice(0, 7).map(p => p.image)]
    : [...PORTFOLIO_ITEMS].reverse().slice(0, 8).map(p => p.image);
